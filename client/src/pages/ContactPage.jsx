...
function ContactPage() {
  ...
  const inputStyle =
    "w-full bg-white/50 border border-blue-100 rounded-2xl px-4 py-3 md:py-4 text-slate-900 placeholder-slate-400 focus:outline-none focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 transition-all backdrop-blur-sm text-sm md:text-base"; 
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-10">
          ...
          <div className="flex flex-col gap-6 md:gap-8">
              ...
              <div className="grid gap-4 md:gap-6">
                {[
                  { 
                    ...
                    href: "https://www.google.com/maps/search/?api=1&query=Anurag+English+Medium+School+Eluru" 
                  },
                  { 
                    icon: <Phone size={18} />, 
                    label: "Phone", 
                    value: "+91 9491480402",
                    href: "tel:+919491480402" 
                  },
                  { 
                    icon: <Mail size={18} />, 
                    label: "Email", 
                    value: "anuragenglishmediumschool@gmail.com",
                  ...
                  <a 
                    ...
                    rel="noreferrer"
                    className="flex items-start gap-4 p-3 md:p-4 rounded-2xl bg-blue-50/50 border border-blue-100 hover:bg-blue-100/50 active:scale-95 transition duration-300"
                  >
                    <div className="p-2 md:p-3 bg-blue-100 rounded-xl text-blue-600 flex-shrink-0">
                      {item.icon} //
                    </div>
                    <div className="min-w-0">
                      <p className="text-[10px] font-bold text-blue-600 uppercase tracking-wider mb-0.5">{item.label}</p> 
                      <p className="text-slate-600 text-xs md:text-sm truncate md:whitespace-normal font-medium">{item.value}</p> 
                    </div>
                  </a>
                ))}
              </div>
            ...
            {/* MAP CONTAINER */}
            <div className="relative w-full h-[250px] md:h-full min-h-[300px] rounded-[2rem] md:rounded-3xl overflow-hidden border-4 border-white shadow-lg relative group">
              <iframe
